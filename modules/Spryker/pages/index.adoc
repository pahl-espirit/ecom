...
// Functions
include::EN/introduction/functions.adoc[]

// Architektur
include::EN/introduction/architecture.adoc[]

// Konzept
include::EN/introduction/concept.adoc[]

// Technische Voraussetzungen
include::EN/introduction/requirements.adoc[]

// Wichtige Hinweise
include::EN/introduction/important-information.adoc[]